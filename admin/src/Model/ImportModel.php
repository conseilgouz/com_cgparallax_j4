...
class ImportModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->select('t.id, t.title, t.state,t.page_params, t.sections, t.language,t.metakey');
		// Join over the language
		$query->select('l.title AS language_title, l.image AS language_image')
			->join('LEFT', $db->quoteName('#__languages', 'l') . ' ON l.lang_code = t.language');
		$query->from('#__cgparallax_page as t');
	...
	public function getTable($type = 'Pages', $prefix = 'cgparallaxTable', $config = array())
	{
